...
# Configuración de estilos para el login (Tema Clam)
...
def paginaprincipal():
    ...
    # Estilo de Frame y Labels para la página principal
    ...
    # Estilo de Frame para la sección de productos
    ...
    def productos():
        ...
        def validar_y_agregar():
            ...
            # Validar si el código ya existe en el Treeview
        ...
        # Vincular selección en la tabla
    ...
    def clientes():
        ...
        # Estilo específico para clientes
        ...
        def validar_y_agregar():
            ...
            # Validar si la identificación ya existe en el Treeview
            for item in tree.get_children():
                val = tree.item(item, "values")
                if val[0] == ident:
            ...
            # Validar formato simple de correo electrónico
    ...
    # =========================
    # FRAME PRINCIPAL (CONTENIDO DE BIENVENIDA)
    # =========================
    ...
    lbl_bienvenida = ttk.Label(frame2, text="🛍️ BIENVENIDO A NUESTRO ESPACIO", style="Title.TLabel")
...
# Vincular eventos de teclado en la ventana de Login
